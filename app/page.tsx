    ...
    >
      ...
      >
        ...
        >
          ...
          <aside
            className={`${isFacebookPinned ? "hidden lg:flex flex-col w-64 shrink-0 fixed top-24 left-10 h-[calc(100vh-120px)] z-50" : "hidden"}`}
          >
          ...
          <aside
            className={`${isFacebookPinned ? "hidden lg:block w-64 shrink-0 fixed top-24 right-10 h-[calc(100vh-120px)] z-50" : "hidden"}`}
          >
            <div
